            ...
            <div className="space-y-6 md:space-y-10 2xl:space-y-12">
              <div className="flex flex-wrap items-center gap-5">
                <div className="flex justify-center w-12">
                  <svg width="50" height="50" viewBox="0 0 29 42" fill="none">
                    <path
              ...
              <div className="flex flex-wrap items-center gap-5">
                <div className="flex justify-center w-12">
                  <svg width="50" height="50" viewBox="0 0 41 42" fill="none">
                    <path
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm">toufiqjilanirabbu7@gmail.com</p>
                </div>
              </div>
              <div className="flex flex-wrap items-center gap-5">
                <div className="flex justify-center w-12">
