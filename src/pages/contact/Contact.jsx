...
const ContactPage = () => {
  ...
  return (
    <div className="py-5 bg-zinc-100 dark:bg-zinc-950">
      <div className="px-10 pt-10 pb-2 max-w-screen-xl mx-auto">
        ...
        <div className="grid gap-12 mt-10 mb-10 md:my-12 md:grid-cols-12">
          <div className="md:col-span-5 text-black dark:text-white">
            <div className="space-y-6 md:space-y-10 2xl:space-y-12">
              <div className="flex flex-wrap items-center gap-5">
                <div className="flex justify-center w-12">
                  <svg width="64" height="64" viewBox="0 0 29 42" fill="none">
                    <path
              ...
              <div className="flex flex-wrap items-center gap-5">
                <div className="flex justify-center w-12">
                  <svg width="64" height="64" viewBox="0 0 41 42" fill="none">
                    <path
          ...
          <div className="md:col-span-7 text-black dark:text-white">
            <form ref={formRef} onSubmit={sendEmail} className="space-y-4">
              <div>
                <input
                  ...
                  name="name"
                  required
                  className="bg-transparent p-5 text-sm w-full outline-none border border-[#00BC91] tracking-wide"
                />
              </div>
              <div>
                <input
              ...
              <div>
                <textarea
                  ...
                  rows="5"
                  required
                  className="bg-transparent px-5 py-4 text-sm w-full outline-none border border-[#00BC91] tracking-wide"
                />
              </div>
              <div>
                <motion.button
                  ...
                  className="p-4 font-bold tracking-wider rounded bg-[#00BC91]"
                >
                  Send Message
                </motion.button>
              </div>
